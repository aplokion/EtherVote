document.addEventListener('DOMContentLoaded', function () {
    ...
    participationButton.addEventListener('click', function () {
        fetchElectionsList('/account/get_user_elections_list', 'Голосования, в которых вы участвовали:');
    });

    createdButton.addEventListener('click', function () {
        fetchElectionsList('/account/get_user_created_elections_list', 'Созданные вами голосования:');
    });

    fetchElectionsList('/account/get_user_elections_list', 'Голосования, в которых вы участвовали:');

    function fetchElectionsList(url, headingText) {
